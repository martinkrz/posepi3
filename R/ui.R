                  ...
                  #tabsetPanel(id="tabs",
                           tabPanel(HTML("Uncertainty in 1/<i>&omega;</i> and <i>R</i><sub>0</sub>"),value=1,id=1,
                                    fluidRow(
                                      column(3,id="sidebar1",
                                        ...
                                        HTML("<p class='normal grey small'>Remaining parameters are assumed to be accurately known.</p>"),
                                        ...
                                        sliderInput("p1", HTML("annual vaccination fraction, <i>p</i> (% per year)"), 
                                                    value = 0,
                                                    min = 0, max = 99, step = 1),
                                      ...
                                      column(3,id="sidebar4",
                                             ...
                                             div(id="form4",
                                                 ...
                                                 sliderInput("al4", HTML("Death onset, 1/<i>&alpha;</i> (days)"),
                                                             value = al_default,
                                                             min = 0, max = al_max, step = al_step),
                                                 sliderInput("p4", HTML("annual vaccination fraction, <i>p</i> (% per year)"), 
                                                    value = 0,
                                                    min = 0, max = 99, step = 1),
                           ...
                           tabPanel("EVPI",value=4,id=4,
                                    fluidRow(
                                      ...
                                      sliderInput("R02", HTML("Basic reproduction number, <i>R</i><sub>0</sub>"), 
                                                  value = c(R0_A1,R0_A2),
                                                  min = R0_min, max = R0_max, step = R0_step),
                                      sliderInput("p2", HTML("annual vaccination fraction, <i>p</i> (% per year)"), 
                                                  value = c(p_A1,p_A2),
                           ...
                           tabPanel("Download & Credits",value=6,id=6,
                                    mainPanel(
                                      ...
                                      hr(),
                                      h4("Download code"),
                                      p(tags$a(href="https://martinkrz.github.io/posepi3","https://martinkrz.github.io/posepi3/")),
